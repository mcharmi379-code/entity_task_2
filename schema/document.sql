CREATE TABLE `document` (
    ...
    `document_a11y_media_file_id` BINARY(16) NULL,
    ...
    CONSTRAINT `fk.document.document_a11y_media_file_id` FOREIGN KEY (`document_a11y_media_file_id`) REFERENCES `media` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
